...
c **********************************************************************
c **********************************************************************
      subroutine elmlib_term(e ,iq  ,x   ,u      ,v  ,p  ,s   
...
c ......................................................................
  700 continue
      if (ilib .eq. 1) then  
c     Elemento hexaedrico de 8 nos (mec-elastico)
        call elmt07_t(e,iq,x,u,v,p,s,ndm,nst,nel,ma,isw)
      endif
      return
c ......................................................................
  800 continue
...
c ......................................................................
 2100 continue
      ...
      return     
c ......................................................................         
 6000 format(1x,'SUBROUTINE ELMLIBPTERM:'
     .,/,5x,'tipo de elemento ',i2,' nao existente, elemento ',i10,' !')
       end
c **********************************************************************
c
...
c
c **********************************************************************
c * Data de criacao    : 14/03/2017                                    *
c * Data de modificaco : 00/00/0000                                    * 
c * ------------------------------------------------------------------ * 
c * NORMAL_VECTOR : calculo do vetor normal a face do elementos        *
c * -------------------------------------------------------------------* 
c * xf     - coordenadas da face do elemento                           *
c * normal - nao definido                                              *
c * ndm    - dimensao                                                  *
c * ------------------------------------------------------------------ * 
c * Parametros de saida:                                               *
c * ------------------------------------------------------------------ * 
...
c * OBS:                                                               *
c **********************************************************************
      subroutine face_normal_vector(xf,normal,ndm)
      implicit none
      integer ndm,i
      real*8 xf(ndm,*),normal(*),v1(3),v2(3),tmp
c ... v1 = x2 - x1
      v1(1) = xf(1,2) - xf(1,1)
      v1(2) = xf(2,2) - xf(2,1)
      v1(3) = xf(3,2) - xf(3,1)
...
c 
c ... v3 = v2 x v1
      call vet(v2,v1,normal)
c .....................................................................
c
c ...
      tmp = dsqrt(normal(1)*normal(1)
     .           +normal(2)*normal(2)
     .           +normal(3)*normal(3))
      tmp = 1.d0/tmp
c ..................................................................... 
