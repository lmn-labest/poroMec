...
c
c *********************************************************************
      subroutine elmt36_pm(e   ,iq      ,x ,u   ,dp,p   ,s
     1                    ,txn ,vplastic,dt,ndm,nst,nel,isw
     2                    ,block_pu,nlit)
c **********************************************************************
...
c * p(nst)     - nao definido                                          *
c * s(nst,nst) - nao definido                                          *
c * txn(6,*)   - tensao nodal
c * vplastic(15,*)- tensoes, delta deformacao entre iteracoes          *
...
c * vplastic(13,*)   - delta pressao entre iteracoes nao lineares      *
c * vplastic(14,*)   - dilatacao volumetrica plastica                  *
c * vplastic(15,*)   - paramentro de endurecimento                     *
c **********************************************************************
      implicit none
      include 'gravity.fi'
      include 'load.fi'
...
c ...
      ...
      real*8 ri,si,ti,w,wt1,wt2,wt3,det
      real*8 rn(10),sn(10),tn(10)
      real*8 ddepsi(6),epsi(6),txi(6),vplastic(15,*),txn(6,*)
      real*8 pi,dpi,ddpi
c ... integracao numerica de tetraedros     
      real*8 pri4(5,3),psi4(5,3),pti4(5,3),wf4(5,3)
      real*8  pri(12,5),psi(12,5),wf(12,5)
...
c ...
      ...
      real*8 a1,a2,a3,tmp
c ... plasticidade
      real*8 alpha_exp,pc0,mcs,c14,g11,def_vol_plast
c ... 
      integer tetra_face_node10(6,4),no
      real*8 tetra_vol,volum
c ... 
...
c ... ddeps(i,n+1) = deps(i,n+1) -  deps(i-1,n+1) 
        ddepsi(1:6) = epsi(1:6) - vplastic(7:12,lx)
c ... ddpi(i,n+1) = dp(i,n+1) -  dp(i-1,n+1) 
        ddpi       = dpi       - vplastic(13,lx)         
c .....................................................................
c
c ... deps(i,n+1)
        vplastic(7:12,lx) = epsi(1:6)
c ... dp(i,n+1)
        vplastic(13,lx)   = dpi       
c .....................................................................
c
...
c       ddpi     = coef_biot*ddpi
c       txi(1:3) = txi(1:3) - ddpi
        tmp      = (1.0d0-coef_biot)*ddpi
        txi(1:3) = txi(1:3) + tmp 
c .....................................................................
c
c ... 
c       call plasticity3d_pm(vplastic(14,lx),txi,mcs,pc0
c    .                      ,alpha_exp      ,ps ,1  ,c14,g11)  
c .....................................................................
c
c ... incremento do incremento de tensao total nos pontos de integracao
        txi(1:3) = txi(1:3) - ddpi
c ......................................................................
c
c ... tx(i,n+1) = tx(1,n) + dtx(1,n+1) + ddtx(2,n+1) + ddtx(3,n+1) + ... 
        vplastic(1:6,lx) = vplastic(1:6,lx) + txi(1:6)
c .....................................................................
c
c ...
        wt1 = w  
...
c
c ...
c       wt1 = w*(coef_biot-1.0d0)*vplastic(14,lx)
c .....................................................................
c
c ...
c       do i = 1, 4 
c         l    = i + 30
c ... Fp = Fp - p = Fp - int((1-coef_biot)*tr(def_plast)*(N~)dv)  
c         p(l) = p(l) + wt1*hp(i)
c .....................................................................
c       enddo
c .....................................................................
...
c .....................................................................
c
c ... extrapolacao das tensoes totais nos pontos de integracoes para
c     os nos
        p(tp)   = vplastic(1,i)           
        p(tp+1) = vplastic(2,i) 
        p(tp+2) = vplastic(3,i) 
...
c ... variacao da porosidade = biot (eps11 + eps22 + eps33) + dp/M
        dpi  = imod_biot*dp(i)
c ... porosidade  
        p(i) = coef_biot*( epsi(1) + epsi(2) + epsi(3) ) + dpi
c .....................................................................
  710 continue
c .....................................................................
      return
